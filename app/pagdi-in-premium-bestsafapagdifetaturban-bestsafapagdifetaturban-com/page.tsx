...
export const metadata: Metadata = {
  ...
  keywords: "pagdi in india, pagdi India, wedding pagdi India, pagdi service India",
  openGraph: {
    title: "Pagdi in India | Safawala India",
    description: "Premium pagdi service in India by Safawala India.",
    url: "https://bestsafapagdifetaturban.com/pagdi-in-premium",
    type: "website",
  },
}

export default function PagdiInIndiaPage() {
  const pageData = {
